...
@section('title', 'Form Edit Data Catalog')
        ...
        <div class="col-md-12">
            ...
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama" placeholder="Title Produk" value="{{$service->nama}}">
                    @error('nama')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Category Produk" value="{{$service->title}}">
                    @error('title')
                    <small style="color:red;">{{$message}}</small>
                    @enderror
                </div>
