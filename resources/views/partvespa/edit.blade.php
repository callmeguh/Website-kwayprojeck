...
@section('title', 'Form Edit Data Portofolio')
        ...
        <div class="col-md-12">
            ...
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="namaparts" placeholder="Nama Client" value="{{$partvespa->namaparts}}">
                    @error('namaparts')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="link" placeholder="Link Medsos" value="{{$partvespa->link}}">
                    @error('link')
                    <small style="color:red;">{{$message}}</small>
                    @enderror
                </div>
