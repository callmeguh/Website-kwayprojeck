...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <h2 class="m-0 text-primary"><img src="{{ asset('template/img/logonavbar.jpg') }}" alt="Gambar mobil" class="me-3" style="width: 40px; height: 35px;">KWAY PROJECK</h2><br>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                        ...
                        @foreach($contact as $kontak)
                            <div class="col-md-4">
                                <div class="bg-light d-flex flex-column justify-content-center p-4">
                                    <h5 class="text-uppercase text-center"> {{ $kontak->nama }} </h5>
                                    <p class="m-0 text-center"><i class="fa fa-phone-alt text-primary me-2"></i>{{ $kontak->nomor }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <h1 class="mb-5">Lokasi BaseCamp KWAY PROJECK</h1>
                </div>
                <div class="col-12" data-wow-delay="0.1s">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.892602157485!2d106.5483980107619!3d-6.277848461426875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69fd653118fa0b%3A0x5ac82f9dce6b2b04!2sCluster%20Agung%20Indah!5e0!3m2!1sid!2sid!4v1721016512119!5m2!1sid!2sid" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
