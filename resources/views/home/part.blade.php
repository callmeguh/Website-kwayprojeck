...
<head>
    <meta charset="utf-8">
    <title>KWAY PROJECK DECORATION</title>
...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <h2 class="m-0 text-primary"><img src="{{ asset('template/img/logonavbar.png') }}" alt="Gambar mobil" class="me-3" style="width: 40px; height: 35px;">KWAY PROJECK</h2><br>
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{ asset('template/img/background.jpg') }});">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Part Chevrolet</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Part Chevrolet</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-primary text-uppercase">// Part Vespa //</h6>
                <h1 class="mb-5">Cari Berbagai Kebutuhan anda</h1>
            </div>
            <div class="row g-4">
                @php $count = 0; @endphp
                @foreach($partchevy as $part)
                    @php $count++; @endphp
                    @if ($count <= 4)
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid" src="/gambar/{{$part->foto}}" alt="">
                                <div class="team-overlay position-absolute start-0 top-0 w-100 h-50">
                                    <a class="btn btn-square mx-1" href="{{$part->link}}" target="_blank"><i class="fas fa-shopping-cart"></i></a>
                                </div>
                            </div>
                            <div class="bg-light text-center p-4">
                                <h5 class="fw-bold mb-0">{{$part->namaparts}}</h5>
                            </div>
                        </div>
                    </div>
                    @else
